 ...
 */
export declare abstract class BaseChain<RunInput extends ChainValues = ChainValues, RunOutput extends ChainValues = ChainValues> extends BaseLangChain<RunInput, RunnableConfig, RunOutput> implements ChainInputs {
    memory?: BaseMemory;
