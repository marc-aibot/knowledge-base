 ...
 */
export declare abstract class BaseLangChain<RunInput, CallOptions extends RunnableConfig, RunOutput> extends Runnable<RunInput, CallOptions, RunOutput> implements BaseLangChainParams {
    /**
 ...
 */
export declare abstract class BaseLanguageModel<CallOptions extends BaseLanguageModelCallOptions = BaseLanguageModelCallOptions, RunOutput = any> extends BaseLangChain<BaseLanguageModelInput, CallOptions, RunOutput> implements BaseLanguageModelParams {
