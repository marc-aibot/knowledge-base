...
export declare abstract class BaseChatModel<CallOptions extends BaseChatModelCallOptions = BaseChatModelCallOptions> extends BaseLanguageModel<CallOptions, BaseMessageChunk> {
    ...
    protected _separateRunnableConfigFromCallOptions(options: CallOptions): [RunnableConfig, this["ParsedCallOptions"]];
